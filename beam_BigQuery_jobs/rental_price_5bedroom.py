...
def parse_line1(line): #for 1-3bedrooms
...
def parse_line2(line): #for 4 bedroom
	...
	start_month_index = 55; # 2015-01 is on column 55
	end_month_index = start_month_index + 12;
...
def parse_line3(line): #for 5 bedroom
	...
	start_month_index = 44; # 2015-01 is on column 44
	end_month_index = start_month_index + 12;
...
def run(argv=None):	
	...
	with beam.Pipeline(options=pipeline_options) as p:
		...
		table_name = "kapetanakissaenzcs327e:zillow.Rental_Price_5Bedroom" # format: project_id:dataset.table
		table_schema = init_bigquery_table()
    
		lines = p | 'ReadFile' >> beam.io.ReadFromText('gs://kapetanakissaenzcs327e1/zillow/Zip_MedianRentalPrice_5Bedroom.csv')
