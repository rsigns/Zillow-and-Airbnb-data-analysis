...
def run(argv=None):	
	...
	with beam.Pipeline(options=PipelineOptions()) as p:
		...
		list_records | 'WriteTmpFile1' >> beam.io.WriteToText('/home/rsaenz8080/code/list_records', file_name_suffix='.txt')
		
		tuple_records = list_records | 'CreateTupleRecords' >> (beam.FlatMap(parse_records))
		
		tuple_records | 'WriteTmpFile2' >> beam.io.WriteToText('/home/rsaenz8080/code/tuple_records', file_name_suffix='.txt')
